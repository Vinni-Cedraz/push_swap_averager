...
void build_memtest500_string(int i, int **table, char command[]) {
    sprintf(
        command,
        "valgrind -q ./push_swap %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
        "%d %d "
...
void build_memtest1000_string(int i, int **table, char command[]) {
    sprintf(
        ...
        table[i][492], table[i][493], table[i][494], table[i][495],
        table[i][496], table[i][497], table[i][498], table[i][499],
		table[i][500], table[i][501], table[i][502], table[i][503], table[i][504],
        table[i][505], table[i][506], table[i][507], table[i][508], table[i][509],
        table[i][510], table[i][511], table[i][512], table[i][513], table[i][514],
        table[i][515], table[i][516], table[i][517], table[i][518], table[i][519],
        table[i][520], table[i][521], table[i][522], table[i][523], table[i][524],
        table[i][525], table[i][526], table[i][527], table[i][528], table[i][529],
        table[i][530], table[i][531], table[i][532], table[i][533], table[i][534],
        table[i][535], table[i][536], table[i][537], table[i][538], table[i][539],
        table[i][540], table[i][541], table[i][542], table[i][543], table[i][544],
        table[i][545], table[i][546], table[i][547], table[i][548], table[i][549],
        table[i][550], table[i][551], table[i][552], table[i][553], table[i][554],
        table[i][555], table[i][556], table[i][557], table[i][558], table[i][559],
        table[i][560], table[i][561], table[i][562], table[i][563], table[i][564],
        table[i][565], table[i][566], table[i][567], table[i][568], table[i][569],
        table[i][570], table[i][571], table[i][572], table[i][573], table[i][574],
        table[i][575], table[i][576], table[i][577], table[i][578], table[i][579],
        table[i][580], table[i][581], table[i][582], table[i][583], table[i][584],
        table[i][585], table[i][586], table[i][587], table[i][588], table[i][589],
        table[i][590], table[i][591], table[i][592], table[i][593], table[i][594],
        table[i][595], table[i][596], table[i][597], table[i][598], table[i][599],
        ...
        table[i][996], table[i][997], table[i][998], table[i][999],
        table[i][0], table[i][1], table[i][2], table[i][3], table[i][4],
        table[i][5], table[i][6], table[i][7], table[i][8], table[i][9],
        table[i][10], table[i][11], table[i][12], table[i][13], table[i][14],
        table[i][15], table[i][16], table[i][17], table[i][18], table[i][19],
