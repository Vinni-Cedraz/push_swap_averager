...
void build_bonus10_string(char memtest[], int i, int **table) {
    sprintf(memtest,
            ...
            "./checker %d %d %d %d %d %d %d %d %d %d) 2>&1",
            table[i][0], table[i][1], table[i][2], table[i][3], table[i][4],
...
void build_bonus15_string(char memtest[], int i, int **table) {
    sprintf(
        ...
        "./checker %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d) 2>&1",
        table[i][0], table[i][1], table[i][2], table[i][3], table[i][4],
        table[i][5], table[i][6], table[i][7], table[i][8], table[i][9],
...
void build_bonus20_string(char memtest[], int i, int **table) {
    sprintf(memtest,
            ...
            "%d %d %d %d %d %d |"
            "./checker %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
            "%d %d %d %d) 2>&1",
            table[i][0], table[i][1], table[i][2], table[i][3], table[i][4],
            table[i][5], table[i][6], table[i][7], table[i][8], table[i][9],
...
void build_bonus100_string(int i, int **table, char command[]) {
    sprintf(
        ...
        "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
        "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d "
        "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d | ./checker %d "
        "%d "
